...
// We define our own props interface to avoid the Recharts generic type errors
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item: any, index: number) => {
            ...
            return (
              <div key={`tooltip-item-${index}`} className={cn("flex w-full flex-wrap items-stretch gap-2 [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-muted-foreground", indicator === "dot" && "items-center")}>
